...
import HomePageGraphique from "@/assets/HomePageGraphique.jpg";
...
const ContactUs = ({ setSelectedPage }: Props) => {
  ...
  return (
    <section id="contactus" className="mx-auto w-6/6 pt-24 pb-32 bg-black text-white">
      <motion.div
      ...
      >
        ...
        >
          <HText>
            <span className="text-primary-500">HAVE A QUESTION?</span> we respond right away
          </HText>
          <p className="my-5">
